...
import { StyledDiv, StyledWrapper } from "../../containers/MeetingFormSelector/Styled";
...
const Lobby = () => {
  ...
  const screenToRender =
    joineeType === USER_TYPES.STUDENT ? <TeacherLobby /> : <StudentLobby />;

//   const screenToRender =
//     joineeType === USER_TYPES.STUDENT ? <StudentLobby /> : <TeacherLobby /> ;
