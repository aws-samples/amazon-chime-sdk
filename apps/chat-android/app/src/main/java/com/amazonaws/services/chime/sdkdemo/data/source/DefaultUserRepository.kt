...
import com.amazonaws.services.chime.sdkdemo.data.*
...
class DefaultUserRepository(
    ...
    override suspend fun registerAppInstanceUserEndpoint(deviceToken: String, appInstanceUserArn: String) = chimeSDKService.registerAppInstanceUserEndpoint(deviceToken, appInstanceUserArn)

    override suspend fun listAppInstanceUserEndpoints(appInstanceUserArn: String) = chimeSDKService.listAppInstanceUserEndpoints(appInstanceUserArn)

    override suspend fun describeAppInstanceUserEndpoint(endpointId: String, appInstanceUserArn: String) = chimeSDKService.describeAppInstanceUserEndpoint(endpointId, appInstanceUserArn)

    override suspend fun updateAppInstanceUserEndpoint(name: String?, allowMessage: AllowMessages, endpointId: String, appInstanceUserArn: String) = chimeSDKService.updateAppInstanceUserEndpoint(name, allowMessage, endpointId, appInstanceUserArn)

    override suspend fun deregisterAppInstanceUserEndpoint(endpointId: String, appInstanceUserArn: String) = chimeSDKService.deregisterAppInstanceUserEndpoint(endpointId, appInstanceUserArn)
    ...
    override suspend fun getCurrentUserEndpoint(): Result<UserEndpoint> {
        ...
        // This is highly unoptimized...should store locally somewhere
